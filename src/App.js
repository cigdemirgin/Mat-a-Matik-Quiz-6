...
export default function App() {
  ...
  /* Challenge
        ...
        Uygulamanın mevcut kullanıcı deneyimi kötü çünkü elementler olması gerektiği zaman görünmüyor veya kaybolmuyor; hepsi bir arada. Göreviniz bunu aşağıdaki şekilde iyileştirmek: 
            ...
            3. gamePlayButtons değişkeninde saklanan butonlar yalnızca oyun başlamışsa görüntülenmelidir. 
            Aksi takdirde, bunlar oluşturulmamalı ve bunun yerine startButton değişkeninde saklanan buton görünmelidir.  
        ...
        İpucu: Bu bileşenin üst seviyesinde herhangi bir yerde showStates() fonksiyonunu çağırabilir ve 
        uygulamanın state'lerine ve kullanıcı etkileşime girdikçe nasıl değiştiklerine aşina olmak için uygulamayla oynayabilirsiniz. 
